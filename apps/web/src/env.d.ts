...
declare global {
	...
	namespace NodeJS {
		interface ProcessEnv {
			...
			readonly SELENA_LOCAL_OPERATOR_ALERTS_ENABLED?: string;
			readonly SELENA_LOCAL_OPERATOR_EMAIL?: string;
			readonly SELENA_LOCAL_RAW_RETENTION_OWNER_APPROVED?: string;
			readonly SELENA_LOCAL_RAW_RETENTION_ORGANIZATION_ID?: string;
			readonly SELENA_LOCAL_CANARY_OWNER_APPROVED?: string;
			readonly SELENA_LOCAL_CANARY_ORGANIZATION_ID?: string;
			readonly SELENA_LOCAL_CANARY_ACTOR_ID?: string;
			readonly SELENA_LOCAL_CANARY_CONFIGURATION_LOCK_ID?: string;
			readonly SELENA_LOCAL_CANARY_GRID_DEFINITION_ID?: string;
			readonly SELENA_LOCAL_CANARY_IDEMPOTENCY_KEY?: string;
			readonly SELENA_LOCAL_CANARY_MAX_SPEND_USD?: string;
			readonly SELENA_LOCAL_CANARY_MAX_CALLS?: string;
