...
function RegisterPage() {
	...
	if (pendingVerification) {
		return (
			<FullPageCard title="Check your email" subtitle={`We sent a verification link to ${email}`} scene="doors">
	...
	return (
		<FullPageCard title="Create your workspace" subtitle="Set up your AI Visibility account" scene="doors">
			{isCloud && (
