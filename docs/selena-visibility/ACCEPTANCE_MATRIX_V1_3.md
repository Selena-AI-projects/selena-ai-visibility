...
| Production/merge | `NO_GO` | Historical provider identity and payload are privately reconciled in staging, but formal evidence acceptance remains blocked (human acceptance and idempotency verification). Diagnostic-2 remains unresolved. PR #96 was mergeable at verified head `4a1fd948`; production is prohibited and no merge was executed. |
