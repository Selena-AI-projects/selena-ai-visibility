...
- Last implementation/evidence commit: `39baeafb` (`Centralize Local execution key parsing`), pushed to `origin/feature/selena-visibility-v1-2-1`; it centralizes the seven-part execution-key parser for generation and budget projection without changing the grammar.
- Feature flags: off
