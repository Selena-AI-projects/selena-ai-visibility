...
export const ENV_REGISTRY: EnvVarSpec[] = [
	...
	{
		name: "SELENA_LOCAL_OPERATOR_ALERTS_ENABLED",
		scope: "server",
		requiredBy: "optional",
		description:
			"Only exact 'true' lets the Local worker email operator alerts; also needs SELENA_LOCAL_OPERATOR_EMAIL and APP_URL.",
	},
	{
		name: "SELENA_LOCAL_OPERATOR_EMAIL",
		scope: "server",
		requiredBy: "optional",
		description: "Recipient for Local operator alerts.",
	},
	{
		name: "SELENA_LOCAL_RAW_RETENTION_OWNER_APPROVED",
		scope: "server",
		requiredBy: "optional",
		description: "Only exact 'true' starts the Local raw-response retention sweep.",
	},
	{
		name: "SELENA_LOCAL_RAW_RETENTION_ORGANIZATION_ID",
		scope: "server",
		requiredBy: "optional",
		description: "The one organization whose retained Local raw responses the sweep expires.",
	},
	{
		name: "SELENA_LOCAL_CANARY_OWNER_APPROVED",
		scope: "server",
		requiredBy: "optional",
		description: "Only exact 'true' lets the one-shot Local canary script create and queue a canary cycle.",
	},
	{
		name: "SELENA_LOCAL_CANARY_ORGANIZATION_ID",
		scope: "server",
		requiredBy: "optional",
		description: "Organization for the one-shot Local canary.",
	},
	{
		name: "SELENA_LOCAL_CANARY_ACTOR_ID",
		scope: "server",
		requiredBy: "optional",
		description: "Owner or admin user recorded as the actor of the one-shot Local canary.",
	},
	{
		name: "SELENA_LOCAL_CANARY_CONFIGURATION_LOCK_ID",
		scope: "server",
		requiredBy: "optional",
		description: "Frozen Local configuration lock the one-shot canary measures.",
	},
	{
		name: "SELENA_LOCAL_CANARY_GRID_DEFINITION_ID",
		scope: "server",
		requiredBy: "optional",
		description: "Grid definition the one-shot canary measures.",
	},
	{
		name: "SELENA_LOCAL_CANARY_IDEMPOTENCY_KEY",
		scope: "server",
		requiredBy: "optional",
		description: "Replay key for the one-shot canary so a rerun cannot create a second cycle.",
	},
	{
		name: "SELENA_LOCAL_CANARY_MAX_SPEND_USD",
		scope: "server",
		requiredBy: "optional",
		description: "Owner-approved spend ceiling in USD for the one-shot canary.",
	},
	{
		name: "SELENA_LOCAL_CANARY_MAX_CALLS",
		scope: "server",
		requiredBy: "optional",
		description: "Owner-approved provider call ceiling for the one-shot canary.",
	},
	{
