...
export const startInstance = createStart(() => ({
	...
	requestMiddleware: wrapMiddlewaresWithSentry({ csrfMiddleware, sentryGlobalRequestMiddleware, deploymentMiddleware }),
	functionMiddleware: wrapMiddlewaresWithSentry({ sentryGlobalFunctionMiddleware, authMiddleware, readOnlyMiddleware }),
}));
