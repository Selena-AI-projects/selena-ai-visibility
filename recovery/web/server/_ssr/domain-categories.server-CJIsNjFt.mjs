import { m as isForumDomain, p as inferPageType } from "./domain-categories-IivSiXtp.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/domain-categories.server-CJIsNjFt.js
(function() {
	try {
		var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
		var n = new e.Error().stack;
		n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "6bfbc71c-3436-41b2-86fe-7521d3406d35", e._sentryDebugIdIdentifier = "sentry-dbid-6bfbc71c-3436-41b2-86fe-7521d3406d35");
	} catch (e) {}
})();
var EDITORIAL_DOMAINS = [
...
var SOCIAL_MEDIA_DOMAINS = /* @__PURE__ */ new Set([
	"facebook.com",
	"twitter.com",
	"x.com",
	"instagram.com",
...
var DEVELOPER_DOMAINS = /* @__PURE__ */ new Set([
	"github.com",
	"gitlab.com",
	"bitbucket.org",
	"sourceforge.net",
...
var PR_WIRE_DOMAINS = /* @__PURE__ */ new Set([
	"prnewswire.com",
	"businesswire.com",
	"globenewswire.com",
	"accesswire.com",
...
var REVIEW_DOMAINS = /* @__PURE__ */ new Set([
	"g2.com",
	"capterra.com",
	"getapp.com",
	"softwareadvice.com",
...
var REFERENCE_DOMAINS = /* @__PURE__ */ new Set([
	"wikipedia.org",
	"wikimedia.org",
	"wiktionary.org",
	"wikivoyage.org",
...
var ECOMMERCE_DOMAINS = /* @__PURE__ */ new Set([
	"amazon.com",
	"amazon.co.uk",
	"amazon.ca",
	"amazon.de",
...
var EDITORIAL_DOMAIN_SET = new Set(EDITORIAL_DOMAINS);
var INSTITUTIONAL_TLDS = /* @__PURE__ */ new Set([
	"edu",
	"gov",
	"mil",
	"int"
]);
var INSTITUTIONAL_SLDS = /* @__PURE__ */ new Set([
	"edu",
	"gov",
	"org",
	"ac",
...
var INSTITUTIONAL_DOMAINS = /* @__PURE__ */ new Set([
	"nhs.uk",
	"nhs.net",
	"nih.gov",
	"cdc.gov",
...
*/
function inDomainSet(domain, set) {
	let d = domain;
	while (true) {
...
function isPrWireDomain(domain) {
	return inDomainSet(domain, PR_WIRE_DOMAINS);
}
function isReviewDomain(domain) {
...
function isReferenceDomain(domain) {
...
function categorizeDomain(domain, brandDomains, competitorDomains) {
	for (const bd of brandDomains) if (domain === bd || domain.endsWith(`.${bd}`)) return "brand";
	for (const cd of competitorDomains) if (domain === cd || domain.endsWith(`.${cd}`)) return "competitor";
...
var EDITORIAL_PAGE_TYPES = /* @__PURE__ */ new Set([
	"article",
	"listicle",
	"howto",
	"comparison",
