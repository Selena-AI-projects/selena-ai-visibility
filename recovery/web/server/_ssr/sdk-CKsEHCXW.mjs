import { t as require_dist } from "./dist-DTm-q9xi.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/sdk-CKsEHCXW.js
(function() {
	try {
		var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof globalThis ? globalThis : "undefined" != typeof self ? self : {};
		var n = new e.Error().stack;
		n && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[n] = "12158a55-8923-4b45-950a-c71f7c5aedab", e._sentryDebugIdIdentifier = "sentry-dbid-12158a55-8923-4b45-950a-c71f7c5aedab");
	} catch (e) {}
})();
...
_SessionToolRunner_requestOptions = function _SessionToolRunner_requestOptions() {
	...
	for (let i = 0; i < SEND_RETRIES; i++) {
		...
		try {
			...
			if (i < 2) await sleep((i + 1) * 1e3, ctrl.signal);
		}
	}
...
_EnvironmentWorker_signal = /* @__PURE__ */ new WeakMap(), _EnvironmentWorker_instances = /* @__PURE__ */ new WeakSet(), _EnvironmentWorker_handleItem = async function _EnvironmentWorker_handleItem(work, environmentKey, externalSignal) {
	...
	const agentToolset = await import("./node-D73QJoXh.mjs");
...
function applyToolChange(block, available) {
	switch (block.type) {
		...
		case "tool_addition":
			...
			break;
		case "mid_conv_system": for (const inner of block.content) if (inner.type === "tool_removal" || inner.type === "tool_addition") applyToolReference(inner, available);
	}
}
...
new TextEncoder();
//#endregion
export { __classPrivateFieldSet as a, __classPrivateFieldGet as i, AnthropicError as n, loggerFor as o, ToolError as r, promiseWithResolvers as s, Anthropic as t };

//# sourceMappingURL=sdk-CKsEHCXW.mjs.map