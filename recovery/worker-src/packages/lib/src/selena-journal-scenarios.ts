...
export const journalScenarios: Readonly<Record<string, JournalScenario>> = {
	...
	avlibali: {
		...
		ownership: "third-party",
		basis: "category-draft",
		// "Avli" is the Greek word for a courtyard and the name of restaurants in
		// other countries, so the bare word is never counted on its own.
		strongAliases: ["AVLI Bali", "avlibali.com", "AVLI Modern Greek", "Avli Uluwatu"],
		weakAliases: ["AVLI", "Avli"],
		questions: [
			"Where can I find Greek food in Bali?",
			"What are the best Greek restaurants in Uluwatu?",
			"Where should I eat dinner in Uluwatu?",
			"What are the best Mediterranean restaurants in Bali?",
			"Where can I find good mezze and dips in Bali?",
			"Which restaurants in Uluwatu are good for a group dinner?",
			"Where can I eat seafood cooked over fire in Bali?",
			"What are the best restaurants near Padang Padang beach?",
			"Where should I go for a special occasion dinner in Uluwatu?",
			"Which restaurants in Bali serve shared plates?",
			"Where can I find a restaurant with a courtyard setting in Bali?",
			"What are the best new restaurants in Uluwatu?",
			"Which restaurants in Uluwatu take reservations?",
			"Where can I find a good wine list in Uluwatu?",
			"Which restaurants in Bali have a party atmosphere at dinner?",
			"Where should I eat in Pecatu?",
			"What are the best date night restaurants in Uluwatu?",
			"Which restaurants in Bali offer private dining or events?",
			"Where can I find vegetarian options at a Mediterranean restaurant in Bali?",
			"What are the best places for dinner on the Bukit peninsula?",
			"Which restaurants in Uluwatu are open late?",
			"Where can I find house-made pita and dips in Bali?",
			"What are the most recommended restaurants in Uluwatu?",
			"Which restaurants in Bali are worth booking in advance?",
			"Where should I eat after sunset near Uluwatu temple?",
		],
		version: "avlibali-en-2026-08-29",
	},
	chitobistro: {
		slug: "chitobistro",
		brand: "Chito Bistro",
