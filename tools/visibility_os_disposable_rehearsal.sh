...
usage() {
	printf '%s\n' \
		'Usage:' \
		'  visibility_os_disposable_rehearsal.sh [--dry-run|--run] [gate12|0045|0049|0051|0052|0057|0058|0059|0060|tenant_isolation|local_external|weekly_digest|variants]' \
		'' \
...
while [[ $# -gt 0 ]]; do
	case "$1" in
		...
		--run) mode='run'; shift ;;
		gate12|0045|0049|0051|0052|0057|0058|0059|0060|tenant_isolation|local_external|weekly_digest|variants) suite="$1"; shift ;;
		-h|--help) usage; exit 0 ;;
...
case "$suite" in
	...
	tenant_isolation) suite_script="$repo_root/tools/visibility_os_tenant_isolation_e2e.sh" ;;
	local_external) suite_script="$repo_root/tools/visibility_os_local_external_e2e.sh" ;;
	weekly_digest) suite_script="$repo_root/tools/visibility_os_weekly_digest_e2e.sh" ;;
